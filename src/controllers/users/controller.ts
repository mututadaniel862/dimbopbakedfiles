...
//     customer_msisdn: z.string().optional()
//   }),
...
//         if (!validatedData.payment.customer_msisdn) {
//           return reply.code(400).send({
//             success: false,
...
//             {
//               customerMsisdn: validatedData.payment.customer_msisdn,
...
//            ...(validatedData.browser_used && { browser_used: validatedData.browser_used }), // ✅ Only include if defined
...
//     customer_msisdn: z.string().optional()
//   }).refine((data) => {
//     // Make customer_msisdn required only for EcoCash payments
//     if (data.payment_method === 'ecocash') {
//       return !!data.customer_msisdn && data.customer_msisdn.trim().length > 0;
//     }
//     return true;
//   }, {
//     message: "Phone number is required for EcoCash payments",
//     path: ["customer_msisdn"]
//   }),
//   shipping_details: shippingDetailsSchema.omit({ 
//     user_id: true, 
//     created_at: true,
...
//         const cleanPhone = validatedData.payment.customer_msisdn.replace('+', '').replace(/\s/g, '');
...
//           payment_method: validatedData.payment.payment_method,
//           transaction_id: transactionId,
//           customerMsisdn: validatedData.payment.customer_msisdn // ADDED THIS LINE
//         },
//         shipping_details: validatedData.shipping_details
//       });
...
//   payment: z.object({
//     payment_method: z.enum(['ecocash', 'card', 'cash']),
//     customer_msisdn: z.string().optional() // Keep snake_case for API input
//   }).refine((data) => {
//     // Make customer_msisdn required only for EcoCash payments
//     if (data.payment_method === 'ecocash') {
//       return !!data.customer_msisdn && data.customer_msisdn.trim().length > 0;
...
//       // Create order in database - FIXED: Convert snake_case to camelCase for Prisma
//       const orderData = await UserPurchaseService.createOrderWithPayment({
//         user_id: validatedData.user_id,
//         total_price: validatedData.total_price,
//         ...(validatedData.browser_used && { browser_used: validatedData.browser_used }),
...
//           payment_method: validatedData.payment.payment_method,
//           transaction_id: transactionId,
//           ...(validatedData.payment.customer_msisdn && { 
//             customerMsisdn: validatedData.payment.customer_msisdn 
//           }) // FIXED: Only include if defined
//         },
//         shipping_details: validatedData.shipping_details
//       });
