...
import serachroute from './routes/serachroute.js';
// import userpayments from './routes/user.js';
import productRoutes from './routes/productroute.js';
import blogRoutes from './routes/blog.js';
import aiRoutes from './routes/aiRouts.js';
import analytics from './routes/analytics.js';
import productAgentRoutes from './routes/productAgents.js';
import oderRoutes from './routes/order.js';
import { JwtUser } from './utils/jwt.js';
import multipart from '@fastify/multipart';
import oauthRoutes from './routes/oauth.js';
import businessDocumentRoutes from './routes/businessDocuments.js';
import agentRoutes from './routes/agents.js';
import { startSubscriptionCron } from './jobs/subscriptionCron.js';
import subscriptionRoutes from './routes/subscription.js';
import paymentRoutes from './routes/payments.js';
import deliveryRoutes from './routes/delivery.js';
import { startCartExpiryJob } from './jobs/cartExpiryJob.js';
