...
//     passport.authenticate('google', async (err: any, user: any) => {
//       if (err || !user) {
//         return reply.code(401).send({ success: false, error: 'Google authentication failed' });
//       }
...
//     passport.authenticate('facebook', async (err: any, user: any) => {
//       if (err || !user) {
//         return reply.code(401).send({ success: false, error: 'Facebook authentication failed' });
//       }
...
//     passport.authenticate('apple', async (err: any, user: any) => {
//       if (err || !user) {
//         return reply.code(401).send({ success: false, error: 'Apple authentication failed' });
//       }
