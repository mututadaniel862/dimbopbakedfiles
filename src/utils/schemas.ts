...
//     phone: null, // Super admin will provide their own phone
...
//     email: 'client.admin@zimnextsmiling.com',
//     password: 'Client!One2025$',
//     phone: null, // Client admin will provide their own phone
//     role: 'client_admin' as const
//   }
//   // NO pre-defined clients - they register themselves 100%
// };
...
//   username: z.literal('super_admin_dan'),
...
//     })
//     .optional(), // Optional for subsequent logins
...
// // ============================================
// // CLIENT ADMIN LOGIN (Must provide phone on first login)
// // ============================================
// export const clientAdminLoginSchema = z.object({
//   username: z.literal('client_one'),
//   password: z.string().min(1, { message: 'Password is required' }),
//   phone: z.string()
//     .min(9, { message: 'Phone number too short' })
//     .max(15, { message: 'Phone number too long' })
...
// // ============================================
// // CLIENT REGISTRATION (Clients create 100% on their own)
// // ============================================
...
//   password: z.string().min(1, { message: 'Password is required' }),
//   phone: z.string().regex(flexiblePhoneRegex).optional(), // For first-time logins
