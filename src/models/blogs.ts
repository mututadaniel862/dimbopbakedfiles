...
export const blogSchema = z.object({
  ...
  blog_image_two: z.string().url().optional().nullable(),
  blog_image_three: z.string().url().optional().nullable(),
  ...
  annotation_image_one: z.string().url().optional().nullable(),
  annotation_image_two: z.string().url().optional().nullable(),
  annotation_image_three: z.string().url().optional().nullable(),
  annotation_image_four: z.string().url().optional().nullable(),
  annotation_image_five: z.string().url().optional().nullable(),
  ...
  meta_og_url: z.string().url().optional().nullable(),
  meta_og_image: z.string().url().optional().nullable(),
