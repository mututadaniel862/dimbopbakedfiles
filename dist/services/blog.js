...
exports.BlogService = {
    ...
    async createBlog(data) {
        try {
            ...
            const validated = blogs_1.blogSchema.parse(data);
    ...
    async updateBlog(id, data) {
        try {
            ...
            const validated = blogs_1.blogSchema.partial().parse(data);
            ...
            return await prisma.$transaction(async (tx) => {
                ...
                if (oldBlog) {
                    ...
                    for (const field of imageFields) {
                        const oldUrl = oldBlog[field];
                        const newUrl = validated[field];
    ...
    // Blog Images Helpers
    async addBlogImage(blogId, imageUrl) {
        try {
