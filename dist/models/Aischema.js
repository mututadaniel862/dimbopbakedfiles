...
//   status         String?   @default("Pending") @db.VarChar(50)
//   created_at     DateTime? @default(now()) @db.Timestamp(6)
//  // ⬇️⬇️⬇️ ADD THESE NEW FIELDS ⬇️⬇️⬇️
...
//   views               Int?          @default(0)
//   // ⬇️⬇️⬇️ ADD THESE NEW FIELDS FOR APPROVAL ⬇️⬇️⬇️
...
//    // ⬇️⬇️⬇️ ADD THESE NEW RELATIONS ⬇️⬇️⬇️
...
// //   @@schema("auth")
// // }
// // 🆕 Hold merchant payments using REAL payment processor features
// model payment_holds {
//   id                    Int       @id @default(autoincrement())
...
//     // ⬇️⬇️⬇️ ADD MERCHANT PAYMENT ACCOUNT INFO ⬇️⬇️⬇️
...
//   // ⬆️⬆️⬆️ END MERCHANT PAYMENT INFO ⬆️⬆️⬆️
//     // ⬇️⬇️⬇️ ADD ONLY THESE AGENT FIELDS ⬇️⬇️⬇️
